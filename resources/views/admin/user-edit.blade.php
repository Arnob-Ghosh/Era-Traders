            ...
            <div class="card-body">
                ...
                <form id="EditUserForm" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="password_confirmation" style="font-weight: normal;">Confirm Password<span
                                    class="text-danger"><strong>*</strong></span></label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-6">
                            ...
                            <select name="roles[]" id="edit_roles" class="form-select w-75" data-live-search="true"
                                aria-label="Default select example" title="Select role" data-width="75%">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 200) {
                        ...
                        $("#edit_roles").val(response.user_roles);
                    }
                },
            });
        }
